...
if (command == 'creator') {
  ...
  const sentMsg = await conn.sendContactArray(m.chat, [
    [`${nomorown}`, `${await conn.getName(nomorown+'@s.whatsapp.net')}`, `👑 Developer Bot `, `🚫 Don't call me 🥺`, `maxxybotz@gmail.com`, `🇮🇩 Indonesia`, `🚀 https://lynk.id/kahfi.xd`, `👤 Gada pawang nih senggol dong 😔`],
