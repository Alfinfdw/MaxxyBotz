...
if (command == 'owner') {
 let vcard = `BEGIN:VCARD\nVERSION:3.0\nN:WhatsApp;Saya Owner Maxxy;Bot;;Md\nFN:Saya Owner Maxxy Bot WhatsApp, Md\nNICKNAME:👑 Owner Galau Bot\nORG:Blitz\nTITLE:soft\nitem1.TEL;waid=6285608468994:+62 856-0846-8994\nitem1.X-ABLabel:📞 Nomor Owner\nitem2.URL:https://lynk.id/kahfi.xd\nitem2.X-ABLabel:💬 More\nitem3.EMAIL;type=INTERNET:galau@mail.com\nitem3.X-ABLabel:💌 Mail Owner galauBot\nitem4.ADR:;;🇮🇩 Indonesia;;;;\nitem4.X-ABADR:💬 More\nitem4.X-ABLabel:📍 Lokasi Saya\nBDAY;value=date:🔖 13 Agustus 1999\nEND:VCARD`
...
if (command == 'creator') {
  ...
  const sentMsg = await conn.sendContactArray(m.chat, [
    [`${nomorown}`, `${await conn.getName(nomorown+'@s.whatsapp.net')}`, `👑 Developer Bot `, `🚫 Don't call me 🥺`, `gataubotz@gmail.com`, `🇮🇩 Indonesia`, `🚀 https://lynk.id/kepo.xd`, `👤 Gada pawang nih senggol dong 😔`],
    [`${conn.user.jid.split('@')[0]}`, `${await conn.getName(conn.user.jid)}`, `🔥 Bot WhatsApp 🐣`, `📵 Don't spam/call me 😢`, `Nothing`, `🇮🇩 Indonesia`, `🚀 https://lynk.id/kefo.xd`, `🤖 Hanya bot biasa yang kadang suka eror ☺`]
  ], fakes)
